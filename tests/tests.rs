...
//                 $(
//                     let $name = async {
//                         let mut subscriber = client.subscribe(agent_id.to_string()).await.unwrap();
...
//         let name =
//             rpc.agent.system.process(sysinfo::Pid::from(test_pid)).map(|p| p.name()).unwrap();
...
//         let req = tokio::spawn(async move {
//             let msgs = [
//                 NatsMsg::KillProc { proc_pid: test_pid as u32 },
//                 NatsMsg::RawCmd {
//                     shell: "cmd".into(),
...
//                 "bash" = NatsResp::RawCMDResp { .. } in "bash" => "cargo -Z help"
//             );
//         };
...
//                         mode: crate::cmd::ScriptMode::Binary {
//                             path: "python3".into(),
//                             ext: ".py".into(),
//                         },
//                         script_args: vec![],
